...
```mermaid
graph LR
    A[شراء من مورد] -->|إضافة| B[مخزون المصنعية 1340]
    B -->|استهلاك| C[بيع للعميل]
    C -->|تكلفة| D[تكلفة المبيعات 50]
```
...
### 1. عند شراء من مورد (إضافة المصنعية)
