...
export const COPY = {
  ...
  staticPages: {
    about: {
      title:       'عن الشركة',
      intro:       'نُقدّم قطعًا ذهبية فريدة بسعر مشتق مباشرةً من سوق الذهب لحظة الشراء — بلا هامش ثابت، بلا تفاوض.',
      missionLabel:'رسالتنا',
      mission:     'أن يكون الذهب الأصيل في متناول الجميع بسعر شفاف وتجربة آمنة.',
      branchesLabel: 'فروعنا',
      branches: [
        { name: 'الفرع الرئيسي — الرياض', address: 'طريق الملك فهد، حي العليا' },
        { name: 'فرع جدة',                 address: 'شارع التحلية، حي الروضة'   },
      ],
    },
    faq: {
      title: 'الأسئلة الشائعة',
      items: [
        { q: 'كيف يُحسب سعر القطعة؟',              a: 'يُحسب السعر تلقائيًا من سعر الذهب الحي لحظة تصفحك، ويشمل وزن الذهب ومصنعية القطعة وأي أحجار أو إضافات.' },
        { q: 'ماذا يعني «حجز القطعة والسعر»؟',      a: 'عند الحجز تُثبَّت القطعة والسعر لمدة 10 دقائق حصريًا لك. إن لم تكمل الدفع خلالها عاد السعر للتحديث.' },
        { q: 'هل يمكن إرجاع القطعة بعد الاستلام؟',  a: 'نعم، يحق لك إرجاع القطعة خلال 7 أيام من الاستلام بشرط عدم الاستخدام والحفاظ على حالتها الأصلية.' },
        { q: 'كيف يمكنني تتبع طلبي؟',               a: 'ادخل رقم طلبك في صفحة التتبع وسنرسل رمز تحقق إلى رقم الجوال المستخدم في الطلب.' },
        { q: 'هل الشحنة مؤمَّنة؟',                  a: 'نعم، كل شحنة مغلَّفة ومؤمَّنة بالكامل حتى لحظة التسليم لك بتوقيع شخصي.' },
      ],
    },
    returns: {
      title:    'سياسة الاسترجاع',
      sections: [
        { heading: 'مدة الاسترجاع',     body: 'يحق للعميل إرجاع القطعة خلال 7 أيام من تاريخ الاستلام.' },
        { heading: 'شروط الاسترجاع',    body: 'يجب أن تكون القطعة غير مستخدمة، محتفظةً بحالتها الأصلية، مرفقةً بشهادة الأصالة وصندوق التغليف.' },
        { heading: 'استرداد المبلغ',    body: 'يُسترد المبلغ كاملًا إلى وسيلة الدفع الأصلية خلال 3–5 أيام عمل.' },
      ],
    },
    terms: {
      ...
      sections: [
        ...
        { heading: 'الحجز والدفع',
          body: 'يمنحك الحجز 10 دقائق لإتمام الدفع. بعد انتهاء المهلة يتحرر الحجز تلقائيًا ويعود السعر للتحديث.' },
        { heading: 'المسؤولية',
          body: 'باستخدام المنصة توافق على الشروط والأحكام المنظِّمة للبيع والشراء. لا تتحمل المنصة مسؤولية تغيرات أسعار الذهب بعد إتمام الشراء.' },
      ],
    },
    privacy: {
      title:    'سياسة الخصوصية',
      sections: [
        { heading: 'البيانات التي نجمعها',  body: 'نجمع رقم الجوال والعنوان لغرض إتمام الطلب وإرسال الشحنة فقط.' },
        { heading: 'استخدام البيانات',       body: 'لا نشارك بياناتك مع أي طرف ثالث إلا لأغراض الشحن والتوصيل الضرورية.' },
        { heading: 'الاحتفاظ بالبيانات',    body: 'تُحتفظ بيانات الطلبات لمدة لا تتجاوز سنتين لأغراض الضمان والاسترجاع.' },
      ],
    },
