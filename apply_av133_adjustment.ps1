...
# ينشئ ويطبّق تصحيح AV-2026-00133 (6,050 SAR) على خزينة مدى
# contra account: كود 340 (فروقات تاريخية)
...
SAFE_BOX_ID              = 32
AMOUNT                   = 6050.00
CLEARING_ACCOUNT_ID      = 777          # حساب مدى GL
CONTRA_ACCOUNT_CODE      = '340'        # فروقات تاريخية
