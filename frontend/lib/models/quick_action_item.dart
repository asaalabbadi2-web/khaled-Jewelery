...
class QuickActionItem {
  ...
  static final Map<int, IconData> _iconLookup = {
    ...
    Icons.lock_clock.codePoint: Icons.lock_clock,
    ...
    Icons.dashboard_customize.codePoint: Icons.dashboard_customize,
